...
If you want to analyze the battery log yourself, you can use [this python script](https://github.com/monal-im/Monal/blob/develop/scripts/power.py). It will output the mean and median values for battery drain and battery loading over the timespan of your battery logging.